    ...
    try:
        ...
        for idx in reversed(ids_mensajes[-30:]):
            ...
            if plataforma == "Prime Video":
                ...
                # REVERTIDO A TU VERSIÓN ORIGINAL (solo con "inicio de sesión" por la variante de Netflix)
                es_login_real = "iniciar sesión" in asunto_lower or "inicio de sesión" in asunto_lower or "iniciar sesión" in cuerpo_limpio or "completa tu solicitud" in cuerpo_limpio or "entrar" in cuerpo_limpio
